...
wp core install --url="lduplain.42.fr" --title="lduplain inception website" --admin_user="lduplain" --admin_password="superprout" --admin_email="lduplain@student.42lyon.fr" --allow-root
